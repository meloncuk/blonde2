      ...
      <div className="relative z-10 mx-auto max-w-[1400px] px-6 md:px-12 py-28 md:py-48 text-center">
        <motion.div className="max-w-3xl mx-auto" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.9, ease: [0.16, 1, 0.3, 1] }}>
          ...
          <div className="mt-12 flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a href="tel:+31201234567" className="group inline-flex items-center justify-center gap-2 px-8 py-4 border border-background/40 text-background text-sm font-medium tracking-wide transition-all duration-300 hover:bg-background/10">
              <Phone size={15} />
              Neem contact op
            </a>
          </div>
